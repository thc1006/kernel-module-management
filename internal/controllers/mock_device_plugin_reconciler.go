...
//
//	mockgen -source=device_plugin_reconciler.go -package=controllers -destination=mock_device_plugin_reconciler.go devicePluginReconcilerHelperAPI,daemonSetCreator
//
...
// clearDevicePluginStatus mocks base method.
func (m *MockdevicePluginReconcilerHelperAPI) clearDevicePluginStatus(ctx context.Context, mod *v1beta1.Module) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "clearDevicePluginStatus", ctx, mod)
	ret0, _ := ret[0].(error)
	return ret0
}

// clearDevicePluginStatus indicates an expected call of clearDevicePluginStatus.
func (mr *MockdevicePluginReconcilerHelperAPIMockRecorder) clearDevicePluginStatus(ctx, mod any) *gomock.Call {
